...
/*
   ...
   Plugin URI: https://github.com/samirdev3/awt-youtube-shortcode
   description: Boost page/post speed by loading Youtube Video on click using shortcode [youtube_video id="w3jLJU7DT5E"]. Won't work on the homepage.
   Version: 1.0.2
   Author: Samir
